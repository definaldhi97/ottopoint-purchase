...
import (
	...
	"ottopoint-purchase/controllers/v2/Redeemtion"
	"ottopoint-purchase/db"
	token "ottopoint-purchase/hosts/redis_token/host"
	"ottopoint-purchase/models"
	"ottopoint-purchase/services"
	"ottopoint-purchase/services/v2/UseVoucher"
...
type V2_UseVouhcerController struct {
}

func (controller V2_UseVouhcerController) UseVouhcerMigrateController(ctx *gin.Context) {
	...
	dataVouch := Redeemtion.SwitchDataVoucher(cekVoucher)
	...
	usevoucher := UseVoucher.V2_UseVoucherServices{
...
func (controller V2_UseVouhcerController) UseVoucherVidioController(ctx *gin.Context) {
