...
type UseVoucherMigrateServices struct {
	General models.GeneralModel
}

func (service UseVoucherMigrateServices) UseVoucherUV(req models.UseVoucherReq, param models.Params) models.Response {
	fmt.Println("[ >>>>>>>>>>>>>>>>>> Use Vouhcer UV Migrate Services <<<<<<<<<<<<<<<< ]")
...
func (service UseVoucherMigrateServices) UseVoucherAggregator(req models.UseVoucherReq, param models.Params) models.Response {
	fmt.Println("[ >>>>>>>>>>>>>>>>>> Use Vouhcer Aggregator Migrate Services <<<<<<<<<<<<<<<< ]")
...
func (service UseVoucherMigrateServices) UseVoucherVidio(couponId string) models.Response {
	fmt.Println("[ >>>>>>>>>>>>>>>>>> Use Vouhcer Vidio Migrate Services <<<<<<<<<<<<<<<< ]")
