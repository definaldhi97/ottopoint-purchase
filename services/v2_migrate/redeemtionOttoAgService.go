...
func RedeemVoucherOttoAg(req models.VoucherComultaiveReq, param models.Params, header models.RequestHeader, getResp chan models.RedeemComuResp, ErrRespRedeem chan error) {
	...
	if dataInquery.Rc != constants.CODE_SUCCESS {
		logrus.Info("[Error-DataInquiry]-[Redeem Comulative Voucher Otto AG]")
		logrus.Error("[Error : %v]", errInquiry)
