...
func (t VoucherAgMigrateServices) VoucherAg(req models.VoucherComultaiveReq, param models.Params, head models.RequestHeader) models.Response {
	...
	RedeemVouchAG, errRedeemVouchAG := Redeem_PointandVoucher(req.Jumlah, param)
