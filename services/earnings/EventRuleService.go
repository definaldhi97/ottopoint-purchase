...
func (t EarningPointServices) EventRuleService(req models.EarningReq, institutionID string) models.Response {
	res := models.Response{}

	sugarLogger := t.General.OttoZaplog
	sugarLogger.Info("[EventRuleService]",
	...
	span, _ := opentracing.StartSpanFromContext(t.General.Context, "[EventRuleService]")
	defer span.Finish()

	fmt.Println("===== EventRuleService =====")
	...
	if errUser != nil || dataUser.CustID == "" {
		...
		fmt.Println(fmt.Sprintf("[EventRuleService]-[Error : %v]", dataUser))
	...
	if errEarning != nil || earning.Code == "" {
		...
		fmt.Println(fmt.Sprintf("[EventRuleService]-[Error : %v]", earning))
	...
	if errPoint != nil || senPoint.PointsTransferId == "" {
		...
		fmt.Println(fmt.Sprintf("[EventRuleService]-[Error : %v]", senPoint))
